...
if len(sys.argv) != 2:
    raise ValueError("Usage: python scripts/run_one_spatial_case.py <resolution>")
...
append_row(
    "results/spatial/spatial_table_manual.csv",
    [out["resolution"], out["num_cells"], out["dt"], out["L2_error"]],
)

print("Saved to results/spatial/spatial_table_manual.csv")